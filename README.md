...
| `dataset/threshold_calibration.csv`     | The 300 manually labeled cases (150 abuse / 150 benign) over which the thresholds were calibrated. Disjoint from the benchmark below.                                                                                                  |
