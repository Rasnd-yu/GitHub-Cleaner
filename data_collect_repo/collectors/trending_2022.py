#!/usr/bin/env python3
"""
2022 GitHub Trending list collection module
Parses the per-language trending lists under archive/repository/2022/
...
MODULE_CONFIG = {
    ...
    'source': '2022 GitHub Trending',  # Data source identifier
    'token': 'xxx',
    # Module-specific token
...
def collect(module_config: Optional[Dict[str, Any]] = None, **kwargs) -> List[str]:
    """
    Collect every repository listed in the trending files under archive/repository/2022/
    ...
    """
    logger.info("Collecting 2022 GitHub Trending repositories...")
    ...
    year_path = Path(archive_path) / "repository" / "2022"
    ...
    date_dirs = sorted(glob.glob(str(year_path / "2022-*-*")))
